...
const scenes = [
  ...
  { id: "curriculum", text: "Two pages that sound similar but do different jobs. Curriculum is the syllabus — modules and lessons organized across four levels: Novice, Amateur, Intermediate, and Advanced. Skills is what actually gets graded. Instructors rate each skill on a three-tier scale — Needs Work, Proficient, or Mastered. Skills marked Critical Core must be fully Mastered to advance a level, while the rest only need to reach Proficient. Students see both pages." },
