              ...
              <CardContent className="space-y-6">
                <div className="flex flex-col items-center pb-6">
                  <Avatar className="h-24 w-24 mb-4">
                    <AvatarFallback className="text-2xl bg-deckademics-accent text-accent-foreground">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={handleChange}
                      placeholder="e.g., Scratching, Beat Matching" 
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    ...
                    value={formData.bio} 
                    onChange={handleChange}
                    placeholder="Share your DJ background and teaching experience" 
                    rows={4} 
                  />
                </div>
              </CardContent>
