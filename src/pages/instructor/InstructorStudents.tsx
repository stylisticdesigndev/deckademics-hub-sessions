        ...
        <Dialog open={showNoteDialog} onOpenChange={setShowNoteDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a note for the student. This will be visible in their profile.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <Textarea
        ...
        <Dialog open={showLessonNoteDialog} onOpenChange={setShowLessonNoteDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a note for the lesson: {selectedLessonTitle}
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <Textarea
        ...
        <Dialog open={showProgressDialog} onOpenChange={setShowProgressDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                {selectedModule 
                  ? `Adjust progress for module: ${selectedModule.moduleName}` 
            ...
            <div className="py-4">
              <div className="space-y-6">
                <div className="space-y-2">
                  <div className="font-medium text-sm">Progress: {progressValue}%</div>
                  <Slider
                    value={[progressValue]}
              ...
              <>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl">{detailedStudent.name}</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-sm font-medium">{detailedStudent.progress}%</div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Button 
                        size="sm" 
                        variant="outline"
                        onClick={() => openNoteDialog(detailedStudent.id)}
                      >
                        Add Note
                      </Button>
                    </div>
                    ...
                    {detailedStudent.notes && detailedStudent.notes.length > 0 ? (
                      <div className="space-y-2 mt-2">
                        {detailedStudent.notes.map((note, index) => (
                          <div key={index} className="text-sm p-3 rounded-md bg-muted/50 border">
                            {note}
                          </div>
                        ))}
                      </div>
                  ...
                  <div className="space-y-4">
                    <h4 className="font-medium">Modules Progress</h4>
                          ...
                          <div key={module.moduleId} className="space-y-2">
                            ...
                            <div className="pt-2 space-y-1.5">
                              {module.lessons.map((lesson) => (
                                <div 
                                  key={lesson.id} 
                                  className="flex items-center justify-between py-1 text-sm border-b border-muted last:border-0"
                                >
                                  <div className="flex items-center gap-2">
                                    <Checkbox 
                                      id={`lesson-${lesson.id}`} 
                  ...
                  {detailedStudent.nextClass && (
                    <div className="pt-4 border-t">
                      <div className="text-sm">
                        <span className="font-medium">Next Class:</span> {detailedStudent.nextClass}
                      </div>
                      <div className="text-sm">
                        <span className="font-medium">Last Active:</span> {detailedStudent.lastActive}
                      </div>
                    </div>
                  )}
                </div>
