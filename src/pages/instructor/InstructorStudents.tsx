        ...
        <Dialog open={showNoteDialog} onOpenChange={setShowNoteDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Add a note for this student's progress or performance.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <Textarea
        ...
        <Dialog open={showLessonNoteDialog} onOpenChange={setShowLessonNoteDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                {selectedLessonTitle && `Add a note for "${selectedLessonTitle}"`}
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <Textarea
                ...
                placeholder="Enter your lesson note here..."
                className="min-h-[150px]"
              />
            </div>
            <DialogFooter>
          ...
          <SheetContent className="w-full sm:max-w-[600px] overflow-y-auto">
            ...
            {detailedStudent && (
              <div className="mt-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{detailedStudent.enrollmentDate}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    {detailedStudent.nextClass && (
                      <div className="flex justify-between">
                        ...
                        <span>{detailedStudent.nextClass}</span>
                      </div>
                    )}
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Last Active:</span>
                      <span>{detailedStudent.lastActive}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-3">
                    <div className="flex items-center gap-3 mb-1">
                      <Progress value={detailedStudent.progress} className="flex-grow h-2" />
                      ...
                      {detailedStudent.moduleProgress.map(module => (
                        <div key={module.moduleId} className="space-y-2">
                          ...
                          <div className="flex items-center gap-3 mb-3">
                            <Progress value={module.progress} className="flex-grow h-2" />
                ...
                <div>
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-medium">Instructor Notes</h3>
                    <Button 
                      variant="outline" 
                      size="sm" 
                  ...
                  <div className="mt-3 space-y-3">
                    {detailedStudent.notes && detailedStudent.notes.length > 0 ? (
                      ...
                      <div className="text-center text-muted-foreground p-3">
                        No notes yet. Add the first note to track student progress.
                      </div>
                    )}
                  </div>
                </div>
