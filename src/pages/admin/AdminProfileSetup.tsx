...
const AdminProfileSetup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Profile updated', description: 'Your admin profile has been set up successfully!' });
  ...
  const handleSkip = () => navigate('/admin/dashboard');
        ...
        <div className="w-full max-w-md">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete your administrator profile to get started</CardDescription>
            </CardHeader>
